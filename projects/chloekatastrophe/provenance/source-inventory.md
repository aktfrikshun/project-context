...
| Allen Taylor | `projects/chloekatastrophe/decisions/adr-006-cybernetic-left-eye.md` | Cybernetic eye textual canon | Accepted decision | Explicitly approved 2026-07-27; adequate image pending | cybernetic-body, Cybernetic Chloe model card | Text governs until an approved image adequately represents the subtle effect |
