---
title: Cybernetic Chloe v1 Reference Pack
status: approved
...
- `cybernetic-chloe-front-full-body.jpeg` — primary anatomy and proportion reference.
...
1. Add new approved originals under stable filenames in `references/`.
2. Calculate SHA-256 checksums locally and add complete manifest records.
3. Review every new visual claim against the media.
4. Change canon only through explicit approval and a reviewed decision.
5. Keep binary reference files in Git LFS.

Relationship to Chloe Model v1: this approved pack is an additive future-continuity layer. It may not redesign Chloe's underlying face, body proportions, restrained performance, or identity anchors.

Source: repository gap analysis performed against `projects/chloekatastrophe/` at source revision recorded by the canon index.
